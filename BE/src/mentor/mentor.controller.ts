...
export class MentorController {
  ...
  @Post('/my-request')
  getAllCodeRequestsByMentorId(@Body() requestBody: { mentorId: number }) {
    const { mentorId } = requestBody;
    return this.mentorService.getAllCodeRequestsByMentorId(mentorId);
  }
}
